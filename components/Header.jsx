...
export default function Header() {
  ...
  return (
    <nav className="flex justify-between sticky w-full -top-1 z-40 items-center px-3 py-5 bg-white shadow-sm lg:px-20 md:px-7">
      ...
      {/* Sliding Mobile Menu */}
      <div
        className={`fixed top-0 right-0 h-full w-full max-w-sm bg-(--color-navy) text-white p-5 z-50 transition-transform duration-300 ease-in-out transform ${
